...
<body class="" style="background-color: #007c7c">
            ...
            <div class="col-xl-6 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        <div class="row ">
                            <div class="col-lg-12 d-none d-lg-block bg-center"></div>
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="" method="POST">
                                        ...
                                        <button class="btn btn-primary btn-user btn-block"style="background-color: #007c7c" type="submit" name="submit">Login</button>
                                    </form>
                                    <hr>
