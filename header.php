...
<body id="page-top">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="logout.php"style="background-color: #007c7c" >Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #007c7c">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a href="#" class="nav-link">
                                <button class="btn btn-primary btn-icon-split" data-toggle="modal" data-target="#logoutModal"style="background-color: #007c7c">
